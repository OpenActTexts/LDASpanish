...
```{r, study, echo=FALSE, fig.cap='El proceso de un estudio típico en ciencias sociales y del comportamiento.', out.width='80%', fig.align='center'}
...
```{r, modeling, echo=FALSE, fig.cap='El proceso de modelación estadística.', out.width='80%', fig.align='center'}
